...
$(document).ready(function () {
    ...
    $(".right-side-toggle-button").on("click", function () {
    ...
    $(window).click(function(e) {
        if(closeOnClickOutside) {
            if(!$(e.target).closest(".right-side-toggle-button").length > 0 ) {
                $(".right-sidebar.shw-rside").slideDown(50).toggleClass("shw-rside");
            }
        }
    });
