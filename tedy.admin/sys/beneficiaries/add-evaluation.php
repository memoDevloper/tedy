...
<div class="modal-header">
    <div class="row" >
        <div class="col-xs-12" >
            <div class="pull-left" >
                <h4>اضافة تقييم للمستفيد: <?php echo $beneficiary->name_ar; ?> - <?php echo $beneficiary->name; ?></h4>
            </div>
...
<form class="form-horizontal form-material form" autocomplete="off" >
    <input type="hidden" name="actionName" value="ADD_EVALUATION" />
                    ...
                    <div class="col-md-12">
                        <select name="furnishing" class="form-control form-control-line furnishing" id="furnishing" >
                            ...
                            foreach ($evaluation_values as $key => $evaluation_value){
                                ?>
                                <option value="<?php echo $key ?>" ><?php  echo $evaluation_value;?></option>
                                <?php
                            }
                            ?>
                        </select>
