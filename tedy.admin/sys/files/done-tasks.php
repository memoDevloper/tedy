...
<div class="modal-header">
    ...
    <div class="row">
        ...
        foreach ($years as $key => $year_) {
            ?>
            <div class="col-md-1 col-xs-3"><a href="#" class="DIM <?php echo ($year == $year_) ? 'text-warning' : ''; ?>" actionName="TRANSLATED_FILES/done-tasks" actionItem="<?php echo $year_ ?>-<?php echo $month; ?>" ><?php echo $year_; ?></a></div>
            <?php
        }
        ?>
    </div>
    <div class="row">
        ...
        foreach ($months_short as $key => $month_) {
            ?>
            <div class="col-md-1 col-xs-3"><a href="#" class="DIM <?php echo ($month == $key) ? 'text-warning' : ''; ?>" actionName="TRANSLATED_FILES/done-tasks" actionItem="<?php echo $year ?>-<?php echo $key; ?>" ><?php echo $month_; ?></a></div>
            <?php
        }
        ?>
    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover manage-u-table" >
                        ...
                        $files = $wam->dbm->getData(['project_items_missions A', 'project_items_translated B'], [
                            ...
                            'eq' => ['A.translator' => $user->id, 'A.year' => $year, 'A.month' => $month],
                            'order' => ['A.deadline'],
                        ]);
