...
<form class="form" >
	...
	<div class="modal-footer" >
        <?php
        if($file->progress_ratio >= 80){
            ?>
            <button type="button" class="btn btn-success DIM" actionName="PROJECTS" actionItem="done-confirm/<?php echo $file->id; ?>">Done</button>
            <?php
        }else{
            ?>
            <button type="button" class="btn btn-success disabled" disabled>Done</button>
            <?php
        }
        ?>
