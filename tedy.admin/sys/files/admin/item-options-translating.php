	...
	<div class="modal-header">
		...
		<div class="row" >
			<div class="col-xs-12" >
				...
				<button type="button" class="btn btn-danger waves-effect waves-light DIM" actionName="TRANSLATED_FILES" actionItem="open-translating/<?php echo $item->name; ?>">Translated</button>
