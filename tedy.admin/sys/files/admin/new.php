<div class="container-fluid">
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">New Job</h4> </div>
		...
		<div class="col-xs-12">
			<div class="white-box">
				<form class="form-horizontal form-material form" autocomplete="off">
					<input type="hidden" name="actionName" value="NEW_FILE">
						...
						<div class="col-md-12">
							<select class="select2 form-control custom-select" name="client" style="width: 100%; height:36px;">
								...
								foreach ($clients as $key => $client) {
									?>
									<option value="<?php echo $client->id ?>">#<?php echo $client->reference ?> - <?php echo $client->name ?> <?php echo $client->lastname; ?> - <?php echo ($client->type == 1) ? 'Client' : 'Company' ?></option>
									<?php
								}
								?>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="number" required name="pages" min="1" class="form-control form-control-line pages" id="pages" placeholder="Files" >
						</div>
					</div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="form-check form-check-inline">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="quotation" value="1" class="custom-control-input job_quotation quotation" id="quotation">
                                    <label for="quotation" >Quotation</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group hidden hidden_job_quotation_ls">
                        <div class="col-sm-12">
                            <div class="form-check form-check-inline">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="ls" value="1" class="custom-control-input job_quotation_ls ls" id="ls">
                                    <label for="ls" >Quotation LS</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group hidden hidden_quotation_ls">
                        <label class="col-md-12" for="quotation_ls">Quotation LS</label>
                        <div class="col-md-12">
                            <input type="text" name="quotation_ls" class="form-control form-control-line quotation_ls" id="quotation_ls" placeholder="Quotation LS" >
                        </div>
                    </div>
                    <div class="form-group hidden hidden_quotation_quantity">
                        <label class="col-md-12" for="quotation_quantity">Quotation Quantity</label>
                        <div class="col-md-12">
                            <input type="number" name="quotation_quantity" class="form-control form-control-line quotation_quantity" id="quotation_quantity" placeholder="Quotation Quantity" >
                        </div>
                    </div>
                    <div class="form-group hidden hidden_quotation_unit_price">
                        <label class="col-md-12" for="quotation_unit_price">Quotation Unit Price</label>
                        <div class="col-md-12">
                            <input type="text" name="quotation_unit_price" class="form-control form-control-line quotation_unit_price" id="quotation_unit_price" placeholder="Quotation Unit Price" >
                        </div>
                    </div>
					<div class="row">
						<label class="col-md-12" for="pages">Job Manager</label>
						<div class="col-md-6">
									...
									foreach ($regular_translators as $key => $translator) {
										...
										<tr>
											<td width="20px" class="text-center" >
												<div class="form-check form-check-inline">
													<div class="custom-control custom-checkbox">
														<input type="checkbox" name="translators[]" value="<?php echo $translator->id ?>" class="custom-control-input" id="user_<?php echo $translator->id ?>">
													</div>
												</div>
											</td>
