...
<form class="form-horizontal form-material form" >
    <div class="modal-header">
        <div class="row" >
            <div class="col-xs-12" >
                <h4 class="pull-left" >Send as Task</h4>
    ...
    <div class="modal-body">
        <div class="row" >
            <input type="hidden" name="actionName" value="FILE_ITEM_OPTIONS_RESEND_MULTIPLE" />
            <?php
            ...
            <div class="col-md-6" >
                <div class="form-group m-l-10" >
                    <input type="checkbox" class="js-switch" name="mission[]" value="TRNS" id="mission_trns" />
                    <label for="mission_compile" >Translae</label>
                </div>
                <div class="form-group m-l-10" >
                    <input type="checkbox" class="js-switch" name="mission[]" value="COMPILE" id="mission_compile" />
                    <label for="mission_compile" >Compile</label>
                </div>
                <div class="form-group m-l-10" >
                    <input type="checkbox" class="js-switch" name="mission[]" value="REVIEW" id="mission_review" />
                    <label for="mission_review" >Review</label>
                </div>
                <div class="form-group m-l-10" >
                    <input type="checkbox" class="js-switch" name="mission[]" value="EDIT" id="mission_edit" />
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-hover manage-u-table" width="100%" >
                            ...
                            $regular_translators = $wam->dbm->getData('users A', [
                                ...
                                'eq' => ['A.type' => [1,2]],
                                'order' => ['A.type, A.name, A.lastname']
                            ]);
