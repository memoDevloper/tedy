	...
	<div class="modal-header">
		...
		<div class="row" >
			<div class="col-xs-12" >
				...
				<button type="button" class="btn btn-danger waves-effect waves-light DIM" actionName="TRANSLATED_FILES" actionItem="open-multiple/<?php echo $item->name; ?>">Multiple Task</button>
										...
										<div class="btn-group" style="position: absolute;" >
											...
											<ul role="menu" class="dropdown-menu">
												...
												foreach ($items as $key => $item) {
													?>
													<li><a href="#" data-download-file="<?php echo $item->id; ?>" data-type="multiple">File <?php echo $i; ?></a></li>
													<?php
													++$i;
												}
												?>
