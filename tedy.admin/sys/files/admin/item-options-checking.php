	...
	<div class="modal-header">
		...
		<div class="row" >
			<div class="col-xs-12" >
				...
				<button type="button" class="btn btn-danger waves-effect waves-light DIM" actionName="TRANSLATED_FILES" actionItem="open-checking/<?php echo $item->name; ?>">Checked</button>
				<button type="button" class="btn btn-danger btn-outline waves-effect waves-light DIM" actionName="TRANSLATED_FILES" actionItem="open-formating/<?php echo $item->name; ?>">Formated</button>
							...
							foreach ($files as $key => $file) {
								...
								<tr class="item" >
									...
									<td>
										...
										?>
										<button type="button" class="btn btn-info btn-outline btn-circle m-r-5 CBDP" data-action="MISSION_DELETE" data-item-id="<?php echo $file->id; ?>" data-toggle="tooltip" title="Delete File"><i class="ti-trash"></i></button>
									</td>
								</tr>
								<?php
							}
