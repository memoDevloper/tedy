	...
	<div class="modal-header">
		...
		<div class="row" >
			<div class="col-xs-12" >
				...
				<button type="button" class="btn btn-danger waves-effect waves-light DIM" actionName="TRANSLATED_FILES" actionItem="open-compiling/<?php echo $item->name; ?>">Compiled</button>
					...
					<table class="table table-hover manage-u-table" >
						...
						<tbody>
							...
							$files = $wam->dbm->getData(['project_items_missions A', 'project_items_translated B'], [
								...
								'eq' => ['B.mission' => 'COMPILE'],
								'li' => ['A.item' => $dir5, 'A.mission' => 'compile'],
