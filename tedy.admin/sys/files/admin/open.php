<div class="container-fluid">
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Job: <?php echo $file->name; ?></h4> </div>
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<a href="/files/open/<?php echo $file->name; ?>/new" class="btn btn-danger pull-right m-l-20 waves-effect waves-light CPB">New File</a>
            <a href="/files/open/<?php echo $file->name; ?>/new-items" class="btn btn-danger pull-right m-l-20 waves-effect waves-light CPB">New Files</a>
			<ol class="breadcrumb">
						...
						<tbody>
							...
							foreach ($files as $key => $file) {
								...
								<tr class="item" >
									...
									<td><?php echo ucfirst($file->direction); ?></td>
                                    <td>
                                        <?php
									...
									<td>
										<span class="text-success" ><?php echo number_format($file->progress_ratio, 1); ?>%</span>
										<div class="progress">
											<div class="progress-bar progress-bar-success " role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo number_format($file->progress_ratio, 1); ?>%;">
												<span class="sr-only"><?php echo number_format($file->progress_ratio, 1); ?>% Complete</span>
											</div>
										</div>
									</td>
									<td>
										<button class="btn btn-info btn-outline btn-circle m-r-5 DIM" actionName="PROJECTS" actionItem="edit-item/<?php echo $file->id; ?>" data-toggle="tooltip" title="Edit" ><i class="ti-pencil-alt"></i></button>
										...
										<button class="btn btn-info btn-outline btn-circle m-r-5 DIM" actionName="TRANSLATED_FILES" actionItem="open/<?php echo $file->name; ?>" data-toggle="tooltip" title="File Options" ><i class="fa fa-gear"></i></button>
										<button type="button" class="btn btn-info btn-outline btn-circle m-r-5 CPDB" data-action="DELETE_ITEM" data-item-id="<?php echo $file->id; ?>" data-toggle="tooltip" title="Delete File"><i class="ti-trash"></i></button>
									</td>
									<td>
										<?php
                                    ...
                                    <td>
                                        <button class="btn <?php echo ($wam->dbm->check('notes', ['eq' => ['section' => 'files', 'item' => $file->id]])) ? 'btn-danger' : 'btn-info'; ?> btn-outline btn-circle m-r-5 DIM" actionName="TRANSLATED_FILES" actionItem="notes-files/<?php echo $file->id; ?>" data-toggle="tooltip" title="Notes" ><i class="fa fa-comment"></i></button>
                                    </td>
								</tr>
								<?php
							}
