<form class="form-horizontal form-material form" >
                            ...
                            <tr class="item" >
                                ...
                                <td>
                                    ...
                                    if($user->id == $note->user) {
                                        ?>
                                        <button class="btn btn-info btn-outline btn-circle m-r-5 DIM" actionName="TRANSLATED_FILES" actionItem="notes-jobs-edit/<?php echo $note->id; ?>" ><i class="ti-pencil-alt"></i></button>
                                        <?php
                                    }
                                    ?>
    ...
    <div class="modal-footer" >
        <button type="button" class="btn btn-success waves-effect waves-light DIM" actionName="TRANSLATED_FILES" actionItem="notes-jobs-new/<?php echo $dir5; ?>" >New</button>
