...
<form class="form-horizontal form-material form" >
    ...
    <div class="modal-footer" >
        <button type="button" class="btn btn-danger waves-effect waves-light DIM" actionName="TRANSLATED_FILES" actionItem="notes-files/<?php echo $note->item; ?>" >Cancel</button>
