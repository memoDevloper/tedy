...
<form class="form-horizontal form-material form" autocomplete="off" >
    <input type="hidden" name="actionName" value="NEW_CENTER" />
        ...
        <div class="row" >
            <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="electricity_no" class="form-control form-control-line electricity_no" id="electricity_no" />
                    </div>
                </div>
            </div>
            <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="water_no" class="form-control form-control-line water_no" id="water_no" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row" >
            <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="internet_no" class="form-control form-control-line internet_no" id="internet_no" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row" >
            <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <textarea name="address" class="form-control form-control-line address" id="address" ></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-6" >
