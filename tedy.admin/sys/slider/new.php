...
<form class="form-horizontal form-material form" autocomplete="off">
    <input type="hidden" name="actionName" value="NEW_SLIDE" />
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="desc_tr" class="form-control form-control-line desc_tr" id="desc_tr" placeholder="الشرح (تركي)" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="desc_ar" class="form-control form-control-line desc_ar" id="desc_ar" placeholder="الشرح (عربي)" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="desc_en" class="form-control form-control-line desc_en" id="desc_en" placeholder="الشرح (الإنجليزي)" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="col-md-12" for="image">الصورة</label>
                    <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="link" class="form-control form-control-line link" id="link" placeholder="رابط الصفحة" />
                    </div>
                </div>
            </div>
        </div>
