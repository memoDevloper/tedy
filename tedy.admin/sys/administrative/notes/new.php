<form class="form-horizontal form-material form" >
    ...
    <div class="modal-body" >
        <div class="row" >
            ...
            <input type="hidden" name="section" value="administrative_files" />
    ...
    <div class="modal-footer" >
        <button type="button" class="btn btn-danger waves-effect waves-light DIM" actionName="ADMINISTRATIVE_FILES" actionItem="notes/<?php echo $dir5; ?>" >Cancel</button>
