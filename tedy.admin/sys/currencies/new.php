...
<form class="form-horizontal form-material form" autocomplete="off" >
    <input type="hidden" name="actionName" value="NEW_CURRENCY" />
        ...
        <div class="row" >
            ...
            <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="code" class="form-control form-control-line code" id="code" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="number" step="any" value="0.00" name="rate" class="form-control form-control-line rate" id="rate" />
                    </div>
                </div>
            </div>
        </div>
