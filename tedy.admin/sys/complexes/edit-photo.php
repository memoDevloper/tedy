...
<form class="form-horizontal form-material form" autocomplete="off" >
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        صور المخطط
                        <button type="button" class="btn btn-success waves-effect waves-light DIM pull-right" actionName="COMPLEXES/edit-photos-sort" actionItem="<?php echo $complex->id; ?>/plan" >تعديل الترتيب</button>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover manage-u-table">
                            <thead>
        ...
        <div class="row">
            <div class="col-md-12">
                <input type="file" id="image-crop-input" data-complex="<?php echo $complex->id; ?>">
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-success waves-effect waves-light DIM" actionName="COMPLEXES/new-photo" actionItem="<?php echo $complex->id; ?>" >صورة جديدة</button>
        <button type="button" class="btn btn-success waves-effect waves-light DIM" actionName="COMPLEXES/new-photos" actionItem="<?php echo $complex->id; ?>" >صور جديدة</button>
        <button type="button" data-method="getCroppedCanvas" class="btn btn-success waves-effect waves-light" >اتمام الطلب</button>
